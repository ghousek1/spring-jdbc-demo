...
public class TutorialController {
  ...
  public ResponseEntity<List<TutorialDto>> getAllTutorials(@RequestParam(required = false) String title) {
      ...
      System.out.println("final tutorials: "+tutorials);

      tutorialRepository.findAll2().forEach(tutorials::add);
  ...
  public ResponseEntity<String> createTutorial(@RequestBody Tutorial tutorial) {
    System.out.println("post tutorials");

    Tutorial tut = new Tutorial(tutorial.getTitle(), tutorial.getDescription(), false);
    System.out.println("tutorial object: "+tut);
